    ...
    http {
      ...
      server {
        ...
        location {{ $key }} {
          ...
          {{- $location_host := printf "location_host%s" (trimSuffix "/" $key | replace "/" "_" | replace "." "_" | replace "-" "_" ) }}
          {{- $location_port := printf "location_port%s" (trimSuffix "/" $key | replace "/" "_" | replace "." "_" | replace "-" "_" ) }}
