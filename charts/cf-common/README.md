...
| service.main | object | `{"annotations":{},"enabled":false,"extraSelectorLabels":{},"labels":{},"ports":{"http":{"port":null,"protocol":"HTTP","targetPort":null}},"primary":true,"trafficDistribution":"PreferSameNode","type":"ClusterIP"}` | Service name |
...
| service.main.trafficDistribution | string | `"PreferSameNode"` | Enable trafficDistribution Ref: https://kubernetes.io/docs/concepts/services-networking/service/#traffic-distribution |
