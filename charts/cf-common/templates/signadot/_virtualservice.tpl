{{- define "cf-common-0.33.0.signadot.virtualservice" }}
...
spec:
  hosts:
  - {{ printf "%s.%s.svc.%s" (include "cf-common-0.33.0.names.fullname" .) .Release.Namespace .Values.global.clusterDomain }}
  http:
  - route:
    - destination:
        host: {{ include "cf-common-0.33.0.names.fullname" . }}
        port:
