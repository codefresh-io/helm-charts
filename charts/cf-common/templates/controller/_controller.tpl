...
{{- define "cf-common-0.9.2.controller" -}}
...
{{- if .Values.controller.enabled -}}
  ...
  {{- if eq .Values.controller.type "rollout" }}
    {{ include "cf-common-0.9.2.controller.rollout" . | nindent 0 }}
    {{- if .Values.controller.rollout.analysisTemplate.enabled }}
    {{ include "cf-common-0.9.2.controller.analysis-template" . | nindent 0 }}
    {{- end }}
  {{- else if eq .Values.controller.type "deployment" }}
    {{ include "cf-common-0.9.2.controller.deployment" . | nindent 0 }}
  {{- else if eq .Values.controller.type "statefulset" }}
    {{ include "cf-common-0.9.2.controller.statefulset" . | nindent 0 }}
  {{- else if eq .Values.controller.type "job" }}
    {{ include "cf-common-0.9.2.controller.job" . | nindent 0 }}
  {{- else if eq .Values.controller.type "cronjob" }}
    {{ include "cf-common-0.9.2.controller.cronjob" . | nindent 0 }}
  {{- else }}
