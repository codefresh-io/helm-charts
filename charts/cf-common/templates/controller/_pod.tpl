...
Usage:
{{ include "cf-common-0.12.3.controller.pod" . }}
*/}}
{{- define "cf-common-0.12.3.controller.pod" -}}

{{- include "cf-common-0.12.3.image.pullSecrets" . }}

serviceAccountName: {{ include "cf-common-0.12.3.names.serviceAccountName" . }}
...
initContainers:
  {{- range $initContainerIndex, $initContainerItem := .Values.initContainers }}
    ...
    {{- include "cf-common-0.12.3.container" (dict "Values" $initContainerItem "context" $) | trim | nindent 0 }}
    {{- end }}
  {{- end }}
{{- end }}

{{- with .Values.container }}
containers: {{ include "cf-common-0.12.3.container" (dict "Values" . "context" $) | trim | nindent 0 }}
{{- end }}
{{- with .Values.additionalContainers }}
{{ toYaml . | nindent 0 }}
{{- end }}

volumes:  {{ include "cf-common-0.12.3.volumes" (dict "Values" .Values.volumes "context" $) | trim | nindent 0 }}

{{- with .Values.extraVolumes }}
{{ include "cf-common-0.12.3.volumes" (dict "Values" . "context" $) | trim }}
{{- end }}
...
topologySpreadConstraints: {{- include "cf-common-0.12.3.tplrender" (dict "Values" . "context" $) | nindent 2 }}
{{- end }}
