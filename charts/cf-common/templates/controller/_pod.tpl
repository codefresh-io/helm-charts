...
Usage:
{{ include "cf-common-0.1.2.controller.pod" . }}
*/}}
{{- define "cf-common-0.1.2.controller.pod" -}}

{{- include "cf-common-0.1.2.image.pullSecrets" . }}

serviceAccountName: {{ include "cf-common-0.1.2.names.serviceAccountName" . }}
...
initContainers: {{- include "cf-common-0.1.2.tplrender" (dict "Values" . "context" $) | nindent 2 }}
{{- end }}

{{- with .Values.container }}
containers: {{ include "cf-common-0.1.2.container" (dict "Values" . "context" $) | trim | nindent 0 }}
{{- end }}
...
topologySpreadConstraints: {{- include "cf-common-0.1.2.tplrender" (dict "Values" . "context" $) | nindent 2 }}
{{- end }}
