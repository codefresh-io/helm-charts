...
Usage:
{{ include "cf-common.controller.pod" . }}
*/}}
{{- define "cf-common.controller.pod" -}}

{{- include "cf-common.image.pullSecrets" . }}

serviceAccountName: {{ include "cf-common.names.serviceAccountName" . }}
...
initContainers: {{- include "cf-common.tplrender" (dict "Values" . "context" $) | nindent 2 }}
{{- end }}

{{- with .Values.container }}
containers: {{ include "cf-common.container" (dict "Values" . "context" $) | trim | nindent 0 }}
{{- end }}
...
topologySpreadConstraints: {{- include "cf-common.tplrender" (dict "Values" . "context" $) | nindent 2 }}
{{- end }}
