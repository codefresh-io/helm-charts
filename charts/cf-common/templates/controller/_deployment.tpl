...
Usage:
{{ include "cf-common.v0.1.0.controller.deployment" . | nindent 0 }}
*/}}

{{- define "cf-common.v0.1.0.controller.deployment" -}}
...
{{- $deploymentName := include "cf-common.v0.1.0.names.fullname" . -}}
