...
{{- define "cf-common.v0.0.24.controller.deployment" -}}
...
{{- $deploymentName := include "cf-common.v0.0.24.names.fullname" . -}}
...
spec:
  ...
  template:
    metadata:
      ...
      annotations:
      {{- include "cf-common.v0.0.24.tplrender" (dict "Values" .Values.podAnnotations "context" $) | nindent 8 }}
      {{- end }}
