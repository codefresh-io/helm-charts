...
spec:
  ...
  {{- end }}
  selector:
    matchLabels: {{ include "cf-common-0.3.0.labels.matchLabels" . | nindent 6 }}
  ...
  template:
    metadata:
      ...
      annotations:
      {{- include "cf-common-0.3.0.tplrender" (dict "Values" .Values.podAnnotations "context" $) | nindent 8 }}
      {{- end }}
