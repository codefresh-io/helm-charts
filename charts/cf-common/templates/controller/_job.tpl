...
Usage:
{{ include "cf-common-0.3.0.controller.job" . | nindent 0 }}
*/}}

{{- define "cf-common-0.3.0.controller.job" -}}
...
spec:
  ...
  selector:
    matchLabels: {{- include "cf-common-0.3.0.tplrender" (dict "Values" .Values.controller.job.selector "context" $) | nindent 6 }}
    {{- else }}
