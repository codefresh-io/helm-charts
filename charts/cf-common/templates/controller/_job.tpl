...
Usage:
{{ include "cf-common-0.9.2.controller.job" . }}
*/}}

{{- define "cf-common-0.9.2.controller.job" -}}
...
spec:
  ...
  selector:
    matchLabels: {{- include "cf-common-0.9.2.tplrender" (dict "Values" .Values.controller.job.selector "context" $) | nindent 6 }}
    {{- else }}
