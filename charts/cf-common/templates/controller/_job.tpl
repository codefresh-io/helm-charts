...
Usage:
{{ include "cf-common-0.1.2.controller.job" . | nindent 0 }}
*/}}

{{- define "cf-common-0.1.2.controller.job" -}}
...
spec:
  ...
  selector:
    matchLabels: {{- include "cf-common-0.1.2.tplrender" (dict "Values" .Values.controller.job.selector "context" $) | nindent 6 }}
    {{- else }}
  ...
  template:
    metadata:
      ...
      {{- end }}
      {{- with include "cf-common-0.1.2.annotations.podAnnotations" . }}
      annotations:
        {{- . | nindent 8}}
      {{- end }}
