...
Usage:
{{ include "cf-common-0.5.1.controller.job" . }}
*/}}

{{- define "cf-common-0.5.1.controller.job" -}}
...
spec:
  ...
  selector:
    matchLabels: {{- include "cf-common-0.5.1.tplrender" (dict "Values" .Values.controller.job.selector "context" $) | nindent 6 }}
    {{- else }}
