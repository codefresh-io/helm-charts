...
*/}}
{{- define "cf-common-0.35.0.kubeVersion" -}}
...
*/}}
{{- define "cf-common-0.35.0.apiVersion.autoscaling" -}}
{{- if .Values.apiVersionOverrides -}}
  ...
  {{- end -}}
{{- else if semverCompare "<1.23-0" (include "cf-common-0.35.0.kubeVersion" . ) -}}
...
*/}}
{{- define "cf-common-0.35.0.apiVersion.externalSecrets" -}}
{{- if .Values.apiVersionOverrides -}}
