...
Usage:
{{ include "cf-common-0.14.0.image.name" (dict "image" .Values.container.image "context" $) }}
*/}}
{{- define "cf-common-0.14.0.image.name" -}}
...
*/}}
{{- define "cf-common-0.14.0.image.pullSecrets" -}}
  {{- $pullSecrets := list }}
  ...
  {{- if .Values.global.imagePullSecrets }}
    ...
    {{- range .Values.global.imagePullSecrets -}}
      {{- $pullSecrets = append $pullSecrets (include "cf-common-0.14.0.tplrender" (dict "Values" . "context" $)) -}}
    {{- end -}}
  {{- end -}}
