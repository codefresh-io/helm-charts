...
Usage:
{{ include "cf-common-0.12.1.image.name" (dict "image" .Values.container.image "context" $) }}
*/}}
{{- define "cf-common-0.12.1.image.name" -}}
...
*/}}
{{- define "cf-common-0.12.1.image.pullSecrets" -}}
  {{- $pullSecrets := list }}
  ...
  {{- if .Values.global.imagePullSecrets }}
    ...
    {{- range .Values.global.imagePullSecrets -}}
      {{- $pullSecrets = append $pullSecrets (include "cf-common-0.12.1.tplrender" (dict "Values" . "context" $)) -}}
    {{- end -}}
  {{- end -}}
