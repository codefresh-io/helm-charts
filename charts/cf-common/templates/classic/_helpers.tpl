...
Usage:
{{ include "cf-common-0.27.0.classic.calculateRabbitMqUri" . }}
*/}}

{{- define "cf-common-0.27.0.classic.calculateRabbitMqUri" }}
...
*/}}
{{- define "cf-common-0.27.0.classic.calculateMongoUri" -}}
...
*/}}
{{- define "cf-common-0.27.0.classic.calculateConsulUri" }}
