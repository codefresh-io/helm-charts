...
Usage:
{{ include "cf-common-0.7.0.classic.calculateRabbitMqUri" . }}
*/}}

{{- define "cf-common-0.7.0.classic.calculateRabbitMqUri" }}
...
Usage:
{{ include "cf.common-0.7.0.classic.calculateMongoUri" (dict "dbName" $.Values.global.pipelineManagerService "mongoURI" $.Values.global.mongoURI) }}
*/}}
{{- define "cf-common-0.7.0.classic.calculateMongoUri" -}}
