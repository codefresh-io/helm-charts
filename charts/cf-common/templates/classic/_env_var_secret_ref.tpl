...
*/}}
{{- define "cf-common-0.35.0.classic.mongodb-host-env-var-secret-name" }}
...
{{- printf (coalesce .Values.mongodbHostSecretKeyRef.name .Values.global.mongodbHostSecretKeyRef.name) }}
  {{- else }}
{{- printf "%s-%s" (include "cf-common-0.35.0.names.fullname" .) "secret" }}
  {{- end }}
{{- end }}
...
*/}}
{{- define "cf-common-0.35.0.classic.mongodb-host-env-var-secret-key" }}
  {{- if or .Values.mongodbHostSecretKeyRef .Values.global.mongodbHostSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.mongodb-user-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.mongodb-user-env-var-secret-key" }}
  {{- if or .Values.mongodbUserSecretKeyRef .Values.global.mongodbUserSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.mongodb-password-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.mongodb-password-env-var-secret-key" }}
  {{- if or .Values.mongodbPasswordSecretKeyRef .Values.global.mongodbPasswordSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.mongo-uri-env-var-value" }}
{{- /*
...
*/}}
{{- define "cf-common-0.35.0.classic.mongo-uri-archive-env-var-value" }}
{{- /*
...
*/}}
{{- define "cf-common-0.35.0.classic.redis-url-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.redis-url-env-var-secret-key" }}
  {{- if or .Values.redisUrlSecretKeyRef .Values.global.redisUrlSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.redis-password-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.redis-password-env-var-secret-key" }}
  {{- if or .Values.redisPasswordSecretKeyRef .Values.global.redisPasswordSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.postgres-hostname-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.postgres-hostname-env-var-secret-key" }}
  {{- if or .Values.postgresHostnameSecretKeyRef .Values.global.postgresHostnameSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.postgres-password-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.postgres-password-env-var-secret-key" }}
  {{- if or .Values.postgresPasswordSecretKeyRef .Values.global.postgresPasswordSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.postgres-user-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.postgres-user-env-var-secret-key" }}
  {{- if or .Values.postgresUserSecretKeyRef .Values.global.postgresUserSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.rabbitmq-hostname-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.rabbitmq-hostname-env-var-secret-key" }}
  {{- if or .Values.rabbitmqHostnameSecretKeyRef .Values.global.rabbitmqHostnameSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.rabbitmq-password-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.rabbitmq-password-env-var-secret-key" }}
  {{- if or .Values.rabbitmqPasswordSecretKeyRef .Values.global.rabbitmqPasswordSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.rabbitmq-username-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.rabbitmq-username-env-var-secret-key" }}
  {{- if or .Values.rabbitmqUsernameSecretKeyRef .Values.global.rabbitmqUsernameSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.firebase-secret-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.firebase-secret-env-var-secret-key" }}
  {{- if or .Values.firebaseSecretSecretKeyRef .Values.global.firebaseSecretSecretKeyRef }}
...
*/}}
{{- define "cf-common-0.35.0.classic.firebase-url-env-var-secret-name" }}
...
*/}}
{{- define "cf-common-0.35.0.classic.firebase-url-env-var-secret-key" }}
  {{- if or .Values.firebaseUrlSecretKeyRef .Values.global.firebaseUrlSecretKeyRef }}
